...
if __name__ == '__main__':
    ...
    for count, task in enumerate(tasks):
        ...
        if isSolved:
            ...
            with open("/home/CE/musaeed/DQN_GRIDWORLD_moreEpisodes/mediumSize/solutions_seq/"+str(count)+".txt", "w") as fb:
        ...
        T.save(agent.Q_eval.state_dict(),"/home/CE/musaeed/DQN_GRIDWORLD_moreEpisodes/mediumSize/checkpoints/agent.pt")
    x = [i+1 for i in range(n_games)]
    filename = '/home/CE/musaeed/DQN_GRIDWORLD_moreEpisodes/mediumSize/grid_world.png'
