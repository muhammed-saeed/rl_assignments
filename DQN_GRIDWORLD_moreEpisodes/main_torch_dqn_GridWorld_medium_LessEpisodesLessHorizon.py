...
if __name__ == '__main__':
    ...
    unSolvedOPtimSeq = "/home/CE/musaeed/DQN_GRIDWORLD_moreEpisodes/mediumSizeLessEpisodesLesshorizon50/unSolvedOptimimumSolutions/"
    unsolvedEnvs = "/home/CE/musaeed/DQN_GRIDWORLD_moreEpisodes/mediumSizeLessEpisodesLesshorizon50/unSolvedEnvs/"
    n_games = 3000
    for count, task in enumerate(tasks):
        ...
        if isSolved:
            ...
            with open("/home/CE/musaeed/DQN_GRIDWORLD_moreEpisodes/mediumSizeLessEpisodesLesshorizon50/solutions_seq/"+str(count)+".txt", "w") as fb:
        ...
        T.save(agent.Q_eval.state_dict(),"/home/CE/musaeed/DQN_GRIDWORLD_moreEpisodes/mediumSizeLessEpisodesLesshorizon50/checkpoints/agent.pt")
    x = [i+1 for i in range(n_games)]
    filename = '/home/CE/musaeed/DQN_GRIDWORLD_moreEpisodes/mediumSizeLessEpisodesLesshorizon50/grid_world.png'
