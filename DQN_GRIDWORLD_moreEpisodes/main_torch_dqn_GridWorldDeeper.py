# import gym
from simple_dqn_torch_2020_deep import Agent
...
if __name__ == '__main__':
    ...
    unSolvedOPtimSeq = "/home/CE/musaeed/DQN_GRIDWORLD_moreEpisodes/deeperNer/unSolvedOptimumSolutions/"
    unsolvedEnvs = "/home/CE/musaeed/DQN_GRIDWORLD_moreEpisodes/deeperNer/unSolvedEnvs/"
    n_games = 4000
    horizon = 100
    for count, task in enumerate(tasks):
        ...
        if isSolved:
            ...
            with open("/home/CE/musaeed/DQN_GRIDWORLD_moreEpisodes/deeperNer/solutionSeq/"+str(count)+".txt", "w") as fb:
        ...
        T.save(agent.Q_eval.state_dict(),"/home/CE/musaeed/DQN_GRIDWORLD_moreEpisodes/deeperNer/checkpoints/agent.pt")
    x = [i+1 for i in range(n_games)]
    filename = '/home/CE/musaeed/DQN_GRIDWORLD_moreEpisodes/deeperNer/grid_world.png'
