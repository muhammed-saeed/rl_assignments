...
if __name__ == '__main__':
    ...
    unSolvedOPtimSeq = "/home/CE/musaeed/DQN_GRIDWORLD_moreEpisodes/unSolvedSeq/"
    unsolvedEnvs = "/home/CE/musaeed/DQN_GRIDWORLD_moreEpisodes/unSolvedEnv/"
    n_games = 4000
    for count, task in enumerate(tasks):
        ...
        if isSolved:
            ...
            with open("/home/CE/musaeed/DQN_GRIDWORLD_moreEpisodes/soloutiotn_seq/"+str(count)+".txt", "w") as fb:
        ...
        T.save(agent.Q_eval.state_dict(),"/home/CE/musaeed/DQN_GRIDWORLD_moreEpisodes/checkpoints/agent.pt")
