...
policy = Policy()
# Load the model
policy.load_state_dict(torch.load("/home/muhammed-saeed/Documents/rl_assignments/Reinforce_policy_gradient_gridworld/curriclumDesignEasy/checkpoints/policy_solved_task.pt"))
